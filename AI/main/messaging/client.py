...
class KafkaMessagingConsumer(AsyncMessagingConsumer):
    def __init__(
        ...
        self.consumer = AIOKafkaConsumer(
            ...
            session_timeout_ms=30000,  # 기본값(예: 10000ms)보다 늘려서 30초로 설정
            heartbeat_interval_ms=10000,  # 기본값(예: 3000ms)보다 늘려서 하트비트 간격 설정
            request_timeout_ms=60000,  # 요청 타임아웃 값도 필요에 따라 조정
